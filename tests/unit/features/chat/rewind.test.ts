...
describe('findRewindContext', () => {
  it('finds the nearest previous assistant UUID and detects a following response UUID', () => {
    const messages: ChatMessage[] = [
      ...
      { id: 'a1', role: 'assistant', content: 'prev', timestamp: 2, runtimeAssistantUuid: 'prev-a' },
      { id: 'u1', role: 'user', content: 'user', timestamp: 3, runtimeUserUuid: 'user-u' },
      { id: 'a2', role: 'assistant', content: 'no uuid', timestamp: 4 },
      { id: 'a3', role: 'assistant', content: 'resp', timestamp: 5, runtimeAssistantUuid: 'resp-a' },
    ];
  ...
  it('does not treat assistants after the next user message as a response', () => {
    const messages: ChatMessage[] = [
      { id: 'a1', role: 'assistant', content: 'prev', timestamp: 1, runtimeAssistantUuid: 'prev-a' },
      { id: 'u1', role: 'user', content: 'user', timestamp: 2, runtimeUserUuid: 'user-u' },
      { id: 'a2', role: 'assistant', content: 'no uuid', timestamp: 3 },
      { id: 'u2', role: 'user', content: 'next user', timestamp: 4, runtimeUserUuid: 'user-u2' },
      { id: 'a3', role: 'assistant', content: 'later resp', timestamp: 5, runtimeAssistantUuid: 'resp-a' },
    ];
  ...
  it('returns prevAssistantUuid as undefined when no prior assistant UUID exists', () => {
    const messages: ChatMessage[] = [
      { id: 'u1', role: 'user', content: 'user', timestamp: 1, runtimeUserUuid: 'user-u' },
      { id: 'a1', role: 'assistant', content: 'resp', timestamp: 2, runtimeAssistantUuid: 'resp-a' },
    ];
