...
import type { CodianMcpServer, McpServerConfig } from '../types';

/** Storage interface for loading MCP servers. */
export interface McpStorageAdapter {
  load(): Promise<CodianMcpServer[]>;
}
...
export class McpServerManager {
  ...
  private collectDisallowedTools(filter?: (server: CodianMcpServer) => boolean): string[] {
  ...
  getContextSavingServers(): CodianMcpServer[] {
