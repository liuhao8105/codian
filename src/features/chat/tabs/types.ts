...
import type { AgentRuntime, InstructionRuntime, TitleRuntime } from '../../../core/runtime';
...
/**
 * Minimal interface for the CodianView methods used by TabManager and Tab.
 * Extends Component for Obsidian integration (event handling, cleanup).
 * Avoids circular dependency by not importing CodianView directly.
 */
...
export interface TabServices {
  ...
  instructionRefineService: InstructionRuntime | null;
  titleGenerationService: TitleRuntime | null;
}
...
export interface TabData {
  ...
  /** Per-tab agent runtime instance for independent streaming. */
  service: AgentRuntime | null;
